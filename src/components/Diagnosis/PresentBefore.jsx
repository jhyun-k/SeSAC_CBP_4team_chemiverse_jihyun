  ...
  return (
    <div className={styles.presentBefore}>
      <div className={styles.testHeader}>
        ...
        <h1 className={styles.testTitle}>사전 점검 Test</h1>
        <p className={styles.testdes}> 본 진단은 엑스퍼트 컨설팅에 입사한 신입사원의 <br/>
        블라블라를 파악하기 위한 사전 진단 테스트입니다.
       </p>
        ...
        진단에 임하는 모든 웅앵은 웅앵해주시길 바랍니다.</p>
         ...
         <img
          className={styles.diaTestHeaderImg}
          src={"/DiagnosisImg/image1.jpeg"}
          alt="test-header-img"
        /> 
      </div>
      ...
      <div className={styles.formArea}>
        ...
        <form onSubmit={handleSubmit}>
            <legend className={styles.testName}> 사전 점검 진단 문항 </legend>
